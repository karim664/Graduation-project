  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => StudentNotifier()),
        ChangeNotifierProvider(create: (context) => SubCategoriesNotifier()),
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        darkTheme: darkTheme(),
        themeMode:
            themes.getThemeMode() == true ? ThemeMode.light : ThemeMode.dark,
