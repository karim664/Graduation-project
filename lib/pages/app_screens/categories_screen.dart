...
class _CategoriesState extends State<Categories> {
  ...
  Widget build(BuildContext context) {
    ...
    {
      return  Center(child: CircularProgressIndicator(color: Theme.of(context).colorScheme.onSecondary,),);
    }
    return Column(
        children: [
          Expanded(
            child: GridView.count(
              ...
              List.generate(
                  category.categoryList.length,
                      (index) => list(
                          context
                          , category.categoryList[index], index))
            ),
          ),
        ],
    );
   ...
   Widget list (context, CategoryModel model, index,)
  {
     ...
     child: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(image: AssetImage(setImage('${model.categoryName}')),fit: BoxFit.cover),
